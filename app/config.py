...
DEFAULT_BG_COLOR = 'grey'  # Default background color for the image. Accepts hex color codes or color names (e.g., '#FF0000', '#F00', or 'red'). Warning : The bg_color query parameter used in the URL must be without the '#'.
